...
//            deleteOldEvents();
    ...
    private void createJSONArray(ArrayList<Shift> shiftList) {
        ...
        {
            JSONObject newShift = new JSONObject();
            try {
                newShift.put("title", shift.getTitle());
                newShift.put("department", shift.getDepartment());
