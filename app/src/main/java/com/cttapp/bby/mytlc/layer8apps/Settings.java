...
//        spinTheme = (Spinner) findViewById(R.id.spinTheme);
        ...
        ArrayAdapter<CharSequence> adapter2 = ArrayAdapter.createFromResource(this, R.array.alarms, android.R.layout.simple_spinner_item);
        adapter2.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinNotifications.setAdapter(adapter2);

        adapter2 = ArrayAdapter.createFromResource(this, R.array.timezones, android.R.layout.simple_spinner_item);
        adapter2.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinTimezone.setAdapter(adapter2);
     ...
     *  AUTHOR: Devin Collins <agent14709@gmail.com>, Bobby Ore <bob1987@gmail.com>, Casey Stark <starkca90@gmail.com>
     ************/
    @SuppressLint("NewApi") private void createCalendarList() {
