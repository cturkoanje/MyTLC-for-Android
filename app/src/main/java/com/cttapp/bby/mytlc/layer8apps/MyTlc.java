 ...
 *************/
@SuppressLint("NewApi") public class MyTlc extends SherlockFragmentActivity implements View.OnClickListener {
...
//	private CheckBox remember;
    ...
    public static Activity currentMyTLCActivity;
...
//        remember = (CheckBox) findViewById(R.id.remember);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
        ...
        Log.v("BACKBUTTON", "-" + item.getItemId());

        if(item.getItemId() == android.R.id.home)
            NavUtils.navigateUpFromSameTask(this);

        if(item.getItemId() == R.id.deleteCreds)
            deleteCredentials();
